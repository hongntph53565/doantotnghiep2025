  ...
  routes: [
    {
      ...
      children: [
        ...
        //http://localhost:5173/admin/cinemas
        {
          path: '/admin/cinemas',
          name: 'ListCinemas',
          component: () => import('@/views/Admin/Cinemas/ListCinemas.vue')
        },

        {
          path: '/admin/cinemas/create',
          name: 'CreateCinema',
          component: () => import('@/views/admin/cinemas/CreateCinema.vue')
        },

        {
          path: '/admin/cinemas/edit/:cinema_id',
          name: 'EditCinema',
          component: () => import('@/views/admin/cinemas/EditCinema.vue'),
          props: true
        }
