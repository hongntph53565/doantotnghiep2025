                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $showtime->movie ? asset('storage/' . $showtime->movie->poster) : asset('images/default-poster.jpg') }}"
                                            class="rounded me-3" alt="Poster" width="50" height="75">

                                        <div>
                                            <div class="fw-semibold">
                                                {{ $showtime->movie->title ?? 'Phim không tồn tại' }}
                                            </div>
                                ...
                                <td>{{ $showtime->room?->room_name ?? 'Chưa có phòng' }}</td>
