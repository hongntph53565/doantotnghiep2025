<div class="header d-flex justify-content-between align-items-center">
  ...
  <div class="header d-flex align-items-center justify-content-end px-3" style="background-color: #fff; height: 60px;">
    <!-- Avatar / User Dropdown -->
    <div class="dropdown">
        @auth
            <button
                class="d-flex align-items-center bg-light rounded px-2 py-1 text-decoration-none dropdown-toggle border-0"
