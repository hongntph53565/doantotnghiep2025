    ...
    <div class="card border-0 shadow-sm mt-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('manager.movies.create') }}" class="btn btn-success">
                    ...
                    <tbody>
                        @foreach ($movies as $movie)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('manager.movies.edit', $movie->movie_id) }}" class="btn btn-outline-primary btn-sm">
                                        <i class="bi bi-pencil-fill"></i>
                                    </a>
                                    <a href="{{ route('manager.movies.show', $movie->movie_id) }}" class="btn btn-outline-primary btn-sm">
