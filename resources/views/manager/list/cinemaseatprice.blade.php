...
@section('content')
                ...
                <form id="addForm" action="{{ route('cinemaseatprices.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="cinema_id" id=""
                                value="{{ $cinemaName }}" disabled>
                        </div>
    ...
    <div class="modal-body">
        <div class="mb-3">
            <label class="form-label">Rạp phim</label>
            <input type="hidden" name="cinema_id" id="editCinemaId" value="{{ $cinema_id }}">
            <input type="text" class="form-control" value="{{ $cinemaName }}" disabled>
        </div>
...
@push('scripts')
    ...
    document.querySelectorAll('.edit-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Gán action đúng
            document.getElementById('editForm').action = `/manager/cinemaseatprice/update/${id}`;
