...
@section('title', 'Lịch Chiếu Rạp')
  @push('styles')
    <link rel="stylesheet" href="{{ asset('client/css/lichchieurap.css') }}">
@endpush
@section('content')
<div class="lich-chieu-rap-wrapper"> 
  ...
  <div class="cinema-box">
    <img style="width: 150px; height: 180px;" src="{{ asset('images\logo.jpg') }}" alt="BHD The Garden" />
    <div>
      ...
      <button class="btn btn-outline-success btn-sm mt-1" onclick="window.location.href='hethongrap.html'">
        → CHỌN RẠP KHÁC
      </button>
    </div>
  </div>
  ...
  <div class="schedule-section">
    ...
    <div class="schedule-box">
      <div class="d-flex flex-wrap">
        ...
        <p class="text-muted mb-3 w-100">BHD Star The Garden</p>
