        ...
        <div id="aboutCarousel" class="carousel slide mb-5" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('images/11.jpg') }}" class="d-block w-100" alt="Sảnh rạp">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('images/12.jpg') }}" class="d-block w-100" alt="Ghế ngồi">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item">
                    <img src="{{ asset('images/13.jpg') }}" class="d-block w-100" alt="Quầy rạp">
                    <div class="carousel-caption d-none d-md-block">
